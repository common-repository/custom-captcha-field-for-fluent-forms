...
Contributors: pyrobd
Tags:  Form, Integration, Fluent Forms, recaptcha, math
...
== Description ==
Add custom recaptcha in Fluent Forms

== Add-On Fluent Forms Custom Recaptcha Field ==
<a href="https://wordpress.org/plugins/fluentform">Fluent Forms</a> is a free and fastest form builder plugin for WordPress. This Plugin is required to use this plugin.
...
=== How To Use ===
Just activate the addon a new field "Recaptcha Field" will appear in fluent form editor, now you can use this field.
...
3. Type "Custom Recaptcha for Fluent Forms" into the Search and hit Enter.
4. Find this plugin Click "install now"
5. Activate The Plugin
6. Go to form editor and search for custom recaptcha field
